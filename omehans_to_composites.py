...
def stitch_z_plane(channel, z_idx, processing, source_dir, output_path, crop_top, crop_bottom):
    ...
    nuc_file_pattern = "*Exc-488nm-561nm-594nm-660nm_HiCAM FLUO_1875-ST-272.fli"
    color_file_pattern = "*Exc-488nm-561nm-594nm-660nm_HiCAM FLUO_1875-ST-088.fli"
    ...
    tifffile.imwrite(
        os.path.join(output_path, f'composite{wanted_name}_wCrop_top{crop_top}_bottom{crop_bottom}_{num_scans}.tiff'),
        arr16,
        bigtiff=True
)
